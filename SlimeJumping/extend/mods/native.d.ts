...
declare type CsType = {
    ...
    "System.IEquatable": System.IEquatable;
...
declare interface CsArrayStatic {
    createCsArray<T1 extends keyof CsType, V extends CsType[T1]>(csType: T1, ...lengths: number[]): CsArray<V>;
    createCsArray(csType: string, ...lengths: number[]): CsArray<Object>;
...
declare module 'Native/GameManager' {
    ...
    */
    ...
    interface GameManagerStatic extends Godot.NodeStatic {
        get Instance(): import("Native/GameManager").GameManager;
        /**
         * 初始化调用
        */
        Init(): void;
    }
    var GameManager: GameManagerConstructor & GameManagerStatic;
}
