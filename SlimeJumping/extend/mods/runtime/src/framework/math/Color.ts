namespace Runtime {
    ...
    export class Color implements IEquatable<Color> {
        ...
        public transition(color: Color, amount: number): Color {
            return new Color(this.r + (color.r - this.r) * amount,
        ...
        public linearInterpolate(to: Color, weight: number | Color): Color {
            if (typeof weight === "number") {
                return new Color(this.r + weight * (to.r - this.r),
                    this.g + weight * (to.g - this.g),
                    this.b + weight * (to.b - this.b),
                    this.a + weight * (to.a - this.a));
            }
            return new Color(this.r + weight.r * (to.r - this.r),
                this.g + weight.g * (to.g - this.g),
                this.b + weight.b * (to.b - this.b),
                this.a + weight.a * (to.a - this.a));
        }
